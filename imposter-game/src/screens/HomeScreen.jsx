      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        <div className="home-header">
          <div className="home-title-group">
            <h1>Imposter Game</h1>
            <p className="home-subtitle">A secret word party game.</p>
          </div>
        ...
        <div className="card home-main-card">
          ...
          <div className="home-button-column" style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            <button className="btn-primary" onClick={onPlay}>
              Play on this device
            </button>

            <button className="btn-primary" onClick={onJoinMulti}>
              Join A Game
            </button>
